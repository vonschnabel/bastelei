...
#url = "https://www.mdr.de/sport/ergebnisse/fussball-dritte-liga-zehnter-spieltag-102.html"
req = Request(url)
...
with open('spieltag.json', 'w', encoding='utf-8') as f:
    json.dump(spieltag, f, ensure_ascii=False, indent=4)

with open('tabelle.json', 'w', encoding='utf-8') as f:
